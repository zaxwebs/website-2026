...
<section>
	<div class="space-y-8 px-4 pt-32 pb-32 lg:pt-20">
		<div
		...
		>
			...
			<p class="mt-0 max-w-2xl lg:mt-2">
				A full brand system designed to position a new boutique fragrance studio as premium,
		...
		<div class="mx-auto flex w-full max-w-[1400px] flex-col justify-between gap-4 lg:flex-row">
			...
			<div>
				...
				<div class="text-xl lg:text-2xl">Brand Strategy. Visual Identity. Packaging Direction.</div>
			</div>
			<div>
				<div class="mb-2 text-sm font-medium tracking-wider uppercase opacity-50">Timeline</div>
				<div class="text-xl lg:text-2xl">6 Weeks</div>
			</div>
			<div>
				<div class="mb-2 text-sm font-medium tracking-wider uppercase opacity-50">Industry</div>
				<div class="text-xl lg:text-2xl">Beauty & Fragrance</div>
			</div>
		</div>
	</div>
</section>
